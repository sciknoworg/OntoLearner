...
from ontolearner import ChordOntology, RWTHDBIS_TaxonomyLearner
...
print(
    "Train edges:", len(train_data.type_taxonomies.taxonomies),
    "Test edges:", len(test_data.type_taxonomies.taxonomies)
)
...
learner = RWTHDBIS_TaxonomyLearner(
